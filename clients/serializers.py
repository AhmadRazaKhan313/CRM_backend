...
class ClientDetailSerializer(serializers.ModelSerializer):
    ...
    academic_detail = SalesDetailSerializer(read_only=True)
...
class ClientCreateSerializer(serializers.ModelSerializer):
    academic_detail = SalesDetailSerializer(required=False)
    ...
    def create(self, validated_data):
        ...
        if academic:
            SalesDetail.objects.create(client=client, **academic)
        if tech:
